...
import { GetEnviosDeUnMaster } from './getEnviosMaster';
...
function DataTableEnviosMaster({id}) {
    ...
    const { data, error, isLoading, } = useSWR(["obtenerEnviosDeMaster", id], () => GetEnviosDeUnMaster(id,AxiosConfigsToken), {})
...
export default DataTableEnviosMaster