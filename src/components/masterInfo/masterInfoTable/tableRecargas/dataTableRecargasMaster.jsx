...
import { GetRecargasMaster } from '../../../flujoSaldo/recargas/getRecargas';
import { GetMasterRecargas } from './getMasterRecargas';
...
function DataTableRecargasMaster({id}) {
    ...
    const { data, error, isLoading, } = useSWR(["obtenerRecargasMaster", id], () => GetMasterRecargas(id,AxiosConfigsToken), {})
