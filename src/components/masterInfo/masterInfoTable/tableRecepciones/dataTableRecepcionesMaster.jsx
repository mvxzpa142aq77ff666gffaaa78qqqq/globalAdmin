...
import { GetRecepcionesDeUnMaster } from './getRecepcionesDeUnMaster';
...
function DataTableRecepcionesMaster({id}) {
    ...
    const { data, error, isLoading, } = useSWR(["obtenerRecepcionesDeMaster", id], () => GetRecepcionesDeUnMaster(id,AxiosConfigsToken), {})
...
export default DataTableRecepcionesMaster
