...
export default function FormInteresASaldoMasters({id}) {
    ...
    const onSubmit = async (data) => {
        ...
        if (data.cantidad === data.cantidadConfirmacion) {
            try {
                setLoad(true)
                const sendData = await AxiosConfigsToken({ url: `/interes_a_saldo_master`, method: "post", data })
                if (sendData.data.verificar) {
                    ...
                    mutate("obtenerInteresASaldoMaster")
                    setLoad(false)
                    handleCloseM()
